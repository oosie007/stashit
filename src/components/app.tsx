    ...
    try {
      ...
      if (manualTags && manualTags.trim()) {
        ...
        try {
          ...
          console.log('AI generated tags:', data);

          if (data.tags && Array.isArray(data.tags) && data.tags.length > 0) {
            tags = data.tags;
          } else {
            console.warn('No tags generated by AI');
            tags = ['untagged'];
          }
        } catch (tagError) {
      ...
      // Create the item with either manual or generated tags
      const newItem = {
        type: 'link',
